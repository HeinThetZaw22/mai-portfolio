    ...
    <Container>
      <div className=" py-8 flex w-full justify-between items-center">
        ...
        <div className=" flex font-poppins items-center text-sm sm:text-md sm:gap-3 gap-1">
          ...
          <button onClick={() => router.push(`/contact`)} className=" cursor-pointer px-4 py-2 text-primary border-2 border-primary hover:bg-primary hover:text-white transition-all duration-200 active:scale-95 rounded-full">
            Say Hello
          </button>
          {/* <Menu /> */}
        </div>
